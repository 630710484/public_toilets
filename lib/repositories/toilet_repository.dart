...
class ToiletRepository {
  ...
  //  Toilet(name: 'ห้องน้ำ 1', point: 4.9, distance: 150.0),
  //  Toilet(name: 'ห้องน้ำ 2', point: 4.1, distance: 50.0),
  // Toilet(name: 'ห้องน้ำ 3', point: 3.7, distance: 350.0),
  //  Toilet(name: 'ห้องน้ำ 4', point: 4.6, distance: 220.0),
  //  Toilet(name: 'ห้องน้ำ 5', point: 4.0, distance: 550.0),
